...
%define DEFINE_STRING_CALLBACK_VOID(
  TYPE,
  JAVA_TYPE, JAVA_METHOD, JAVA_SIGN)
  %typemap(in) TYPE %{
    jclass $input_object_class = jenv->GetObjectClass($input);
...
%{
#include <memory> // make_shared<GlobalRefGuard>
%}

DEFINE_STRING_CALLBACK_VOID(
  std::function<std::string()>,
  Supplier<String>, "get", "()Ljava/lang/String")

DEFINE_CALLBACK_VOID(
  std::function<bool()>,
